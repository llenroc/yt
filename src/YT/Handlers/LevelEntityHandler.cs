   ...
   public class LevelEntityHandler<T> :ILevelEntityHandler<T> where T:class ,ITreeLevel
   {
        ...
        public LevelEntityHandler(IRepository<T> repository)
       {
        ...
        public virtual void Create(T t)
        {
            ...
            List<T> childs = GetParentChilds(t).ToList();
        ...
        public virtual void Delete(T t, Action<T> action = null)
        {
            List<T> childs = GetAllChilds(t).ToList();
            if (childs.Any())
            {
        ...
        public IEnumerable<T> GetAllRoot()
        {
            return Repository.GetAllList(t => t.ParentId == null);
        }
